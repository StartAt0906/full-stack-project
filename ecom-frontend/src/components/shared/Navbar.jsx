...
const Navbar = () => {
    ...
    return (
        <div className="h-[70px] bg-custom-gradient text-white z-50 flex items-center sticky top-0">
            ...
            <ul className={`flex sm:gap-4 sm:items-center text-slate-800 sm:static absolute left-0 top-[70px] sm:shadow-none shadow-md ${
                ...
                <li className="font-[500] transition-all duration-150">
                    <Link className="flex items-center space-x-2 px-4 py-[6px]
                                ...
                                hover:from-purple-500 hover:to-red-400 transitionduration-300 ease-in-out transform"
                    to="/login">
                        <FaSignInAlt />
                        <span>Login</span>
                    </Link>
