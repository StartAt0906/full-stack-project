...
public class OrderController {
    ...
    public ResponseEntity<OrderDTO> updataOrderStatus(@PathVariable long orderId,
                                                      @RequestBody OrderUpdateStatusDto orderUpdateStatusDto)
    {
        OrderDTO order = orderService.updateOrder(orderId,orderUpdateStatusDto.getStatus());
        return new ResponseEntity<OrderDTO>(order, HttpStatus.OK);
    }

    @PutMapping("/seller/orders/{orderId}/status")
    public ResponseEntity<OrderDTO> updataOrderStatusSeller(@PathVariable long orderId,
                                                      @RequestBody OrderUpdateStatusDto orderUpdateStatusDto)
    {
        OrderDTO order = orderService.updateOrder(orderId,orderUpdateStatusDto.getStatus());
        return new ResponseEntity<OrderDTO>(order, HttpStatus.OK);
